...
color_map = {"ignore_label": (0, 0, 0), "barrier": (112, 128, 144), "bicycle": (220, 20, 60), "bus": (255, 127, 80),
             "car": (255, 158, 0), "construction_vehicle": (233, 150, 70), "motorcycle": (255, 61, 99),
             "pedestrian": (0, 0, 230), "traffic_cone": (47, 79, 79), "trailer": (255, 140, 0),
             "truck": (255, 99, 71), "driveable_surface": (0, 207, 191), "flat_other": (175, 0, 75),
             "sidewalk": (75, 0, 75), "terrain": (112, 180, 60), "manmade": (222, 184, 135),
             "vegetation": (0, 175, 0)}

map_ = numpy.asarray(list(color_map.values()))/255.
...
class Tensorboard:
    def __init__(self, hyp_param_, online=False):
        os.environ['WANDB_API_KEY'] = hyp_param_.wandb_key
