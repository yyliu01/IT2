...
nohup python3 nuscenes.code.ItTakesTwo.gmm/main.py --labelled_percent="$1" --gpus=4 --scale=train_val --batch_size=4 --lr=6e-3 --epoch=${max_epoch} --unlabelled_weight=${unlabelled_weight} > nuscenes_hist_"$1"_"${max_epoch}".out &
